    ...
    if (type === "lottery") {
      ...
      return new ImageResponse(
        (
          ...
          >
            <div style={{ display: "flex", position: "absolute", top: 0, left: 0, right: 0, height: "6px", background: "linear-gradient(90deg, #e87a2e, #ff9f43, #ffc312)" }} />
      ...
      return new ImageResponse(
        (
          ...
          >
            ...
            <div style={{ display: "flex", fontSize: "28px", fontWeight: 900, padding: "6px 24px", borderRadius: "12px", backgroundColor: "rgba(255,195,18,0.15)", color: scoreColor, marginTop: "16px" }}>
              Grade: {grade}
            </div>
            {player && (
    ...
    return new ImageResponse(
      (
        ...
        >
          ...
          <div style={{ fontSize: "18px", color: "#5c5c66", marginTop: "8px" }}>Draft Tracker · Lottery Sim · War Room · Hot Takes</div>
        </div>
      ),
      { width: 1200, height: 630 },
    );
