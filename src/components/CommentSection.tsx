...
function InlineReplyForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-3 pl-4 border-l-2 border-brand-red/30">
        ...
        {editing ? (
          <div className="mb-2">
            <textarea
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-[15px] text-text-primary resize-none focus:outline-none focus:border-brand-red/30"
              rows={3}
              maxLength={500}
            />
              ...
              {currentUserHandle && (
                <button
                  ...
                  className={`flex items-center gap-1 text-xs font-semibold transition-colors ${
                    isReplying ? "text-brand-red" : "text-text-muted hover:text-brand-red"
                  }`}
                >
      ...
      {visibleReplies.length > 0 && (
        <div>
          ...
          {!showAll && hiddenCount > 0 && (
            <button onClick={() => setShowAll(true)} className="ml-6 pl-4 py-2 text-brand-red text-xs font-semibold hover:underline">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              <textarea
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-text-primary placeholder:text-text-muted/50 resize-none focus:outline-none focus:border-brand-red/30 transition-colors"
                rows={compact ? 1 : 2}
                maxLength={500}
              />
