...
export interface DraftPick {
  label: string;       // e.g. "2026 1st (BKN)"
  team: string;        // team that owns it
  year: number;
  round: 1 | 2;
  originalTeam: string; // who it originally belongs to
  protection?: string;  // e.g. "Top 8 protected"
  estimatedValue: number; // rough salary-equivalent for trade display
}
...
const BKN: NBATeam = {
  ...
  picks: [
    { label: "2026 1st (BKN)", team: "BKN", year: 2026, round: 1, originalTeam: "BKN", estimatedValue: 0 },
    { label: "2026 1st (DEN)", team: "BKN", year: 2026, round: 1, originalTeam: "DEN", estimatedValue: 0 },
    { label: "2027 1st (NYK)", team: "BKN", year: 2027, round: 1, originalTeam: "NYK", protection: "Unprotected", estimatedValue: 0 },
    { label: "2027 1st (PHX swap)", team: "BKN", year: 2027, round: 1, originalTeam: "PHX", protection: "Swap rights", estimatedValue: 0 },
    { label: "2028 1st (BKN)", team: "BKN", year: 2028, round: 1, originalTeam: "BKN", estimatedValue: 0 },
    { label: "2028 1st (PHI)", team: "BKN", year: 2028, round: 1, originalTeam: "PHI", protection: "Top 8 protected", estimatedValue: 0 },
    { label: "2026 2nd (PHI)", team: "BKN", year: 2026, round: 2, originalTeam: "PHI", estimatedValue: 0 },
    { label: "2027 2nd (LAL)", team: "BKN", year: 2027, round: 2, originalTeam: "LAL", estimatedValue: 0 },
  ],
  players: [
...
const otherTeams: NBATeam[] = [
  { name: "Los Angeles Lakers", abbrev: "LAL", conference: "West", picks: [
    { label: "2026 1st (LAL)", team: "LAL", year: 2026, round: 1, originalTeam: "LAL", estimatedValue: 0 },
    { label: "2027 1st (LAL)", team: "LAL", year: 2027, round: 1, originalTeam: "LAL", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Golden State Warriors", abbrev: "GSW", conference: "West", picks: [
    { label: "2026 1st (GSW)", team: "GSW", year: 2026, round: 1, originalTeam: "GSW", estimatedValue: 0 },
    { label: "2027 1st (GSW)", team: "GSW", year: 2027, round: 1, originalTeam: "GSW", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Boston Celtics", abbrev: "BOS", conference: "East", picks: [
    { label: "2026 1st (BOS)", team: "BOS", year: 2026, round: 1, originalTeam: "BOS", estimatedValue: 0 },
    { label: "2027 1st (BOS)", team: "BOS", year: 2027, round: 1, originalTeam: "BOS", estimatedValue: 0 },
  ], players: [
  ...
  { name: "New York Knicks", abbrev: "NYK", conference: "East", picks: [
    { label: "2026 1st (NYK)", team: "NYK", year: 2026, round: 1, originalTeam: "NYK", estimatedValue: 0 },
    { label: "2027 1st (NYK)", team: "NYK", year: 2027, round: 1, originalTeam: "NYK", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Houston Rockets", abbrev: "HOU", conference: "West", picks: [
    { label: "2026 1st (HOU)", team: "HOU", year: 2026, round: 1, originalTeam: "HOU", estimatedValue: 0 },
    { label: "2027 1st (HOU)", team: "HOU", year: 2027, round: 1, originalTeam: "HOU", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Dallas Mavericks", abbrev: "DAL", conference: "West", picks: [
    { label: "2026 1st (DAL)", team: "DAL", year: 2026, round: 1, originalTeam: "DAL", estimatedValue: 0 },
    { label: "2027 1st (DAL)", team: "DAL", year: 2027, round: 1, originalTeam: "DAL", estimatedValue: 0 },
  ], players: [
  ...
  { name: "San Antonio Spurs", abbrev: "SAS", conference: "West", picks: [
    { label: "2026 1st (SAS)", team: "SAS", year: 2026, round: 1, originalTeam: "SAS", estimatedValue: 0 },
    { label: "2027 1st (SAS)", team: "SAS", year: 2027, round: 1, originalTeam: "SAS", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Oklahoma City Thunder", abbrev: "OKC", conference: "West", picks: [
    { label: "2026 1st (OKC)", team: "OKC", year: 2026, round: 1, originalTeam: "OKC", estimatedValue: 0 },
    { label: "2027 1st (OKC)", team: "OKC", year: 2027, round: 1, originalTeam: "OKC", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Cleveland Cavaliers", abbrev: "CLE", conference: "East", picks: [
    { label: "2026 1st (CLE)", team: "CLE", year: 2026, round: 1, originalTeam: "CLE", estimatedValue: 0 },
    { label: "2027 1st (CLE)", team: "CLE", year: 2027, round: 1, originalTeam: "CLE", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Phoenix Suns", abbrev: "PHX", conference: "West", picks: [
    { label: "2026 1st (PHX)", team: "PHX", year: 2026, round: 1, originalTeam: "PHX", estimatedValue: 0 },
    { label: "2027 1st (PHX)", team: "PHX", year: 2027, round: 1, originalTeam: "PHX", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Miami Heat", abbrev: "MIA", conference: "East", picks: [
    { label: "2026 1st (MIA)", team: "MIA", year: 2026, round: 1, originalTeam: "MIA", estimatedValue: 0 },
    { label: "2027 1st (MIA)", team: "MIA", year: 2027, round: 1, originalTeam: "MIA", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Philadelphia 76ers", abbrev: "PHI", conference: "East", picks: [
    { label: "2026 1st (PHI)", team: "PHI", year: 2026, round: 1, originalTeam: "PHI", estimatedValue: 0 },
    { label: "2027 1st (PHI)", team: "PHI", year: 2027, round: 1, originalTeam: "PHI", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Chicago Bulls", abbrev: "CHI", conference: "East", picks: [
    { label: "2026 1st (CHI)", team: "CHI", year: 2026, round: 1, originalTeam: "CHI", estimatedValue: 0 },
    { label: "2027 1st (CHI)", team: "CHI", year: 2027, round: 1, originalTeam: "CHI", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Toronto Raptors", abbrev: "TOR", conference: "East", picks: [
    { label: "2026 1st (TOR)", team: "TOR", year: 2026, round: 1, originalTeam: "TOR", estimatedValue: 0 },
    { label: "2027 1st (TOR)", team: "TOR", year: 2027, round: 1, originalTeam: "TOR", estimatedValue: 0 },
  ], players: [
  ...
  { name: "Milwaukee Bucks", abbrev: "MIL", conference: "East", picks: [
    { label: "2026 1st (MIL)", team: "MIL", year: 2026, round: 1, originalTeam: "MIL", estimatedValue: 0 },
    { label: "2027 1st (MIL)", team: "MIL", year: 2027, round: 1, originalTeam: "MIL", estimatedValue: 0 },
  ], players: [
